namespace MidiParser
{
    ...
    public class MidiFile
    {
        ...
        public static MidiTrack MergeTracks(MidiTrack[] tracks)
        {
            var track = new MidiTrack();
            var l = new List<MidiEvent>();
            foreach (var t in tracks)
                l.AddRange(t.MidiEvents);
            l.Sort(delegate (MidiEvent x, MidiEvent y) { return x.Time.CompareTo(y.Time); });
            track.MidiEvents.AddRange(l);
            return track;
        }
